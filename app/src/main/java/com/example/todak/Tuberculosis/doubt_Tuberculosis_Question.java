package com.example.todak.Tuberculosis;
...
public class doubt_Tuberculosis_Question extends AppCompatActivity {
    double score =0;
    double num_of_q = 11;
    double rate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(previous)
        {
            Intent intent = new Intent(doubt_Tuberculosis_Question.this, doubt_Tuberculosis_Question.class);
            startActivity(intent);
        }
        setContentView(R.layout.doubt_tuberculosis_question);
        ...
        resultButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(doubt_Tuberculosis_Question.this, doubt_Tuberculosis_Result.class);
                rate = Math.round(100.0*(score/(num_of_q)*100/100.0));

                intent.putExtra("Disease" , "결핵");
