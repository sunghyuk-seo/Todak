...
public class doubt_cerebral_infarction_Question extends AppCompatActivity {
    double score =0;
    double num_of_q = 13;
    double rate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(doubt_cerebral_infarction_Question.this, doubt_cerebral_infarction_Result.class);
                rate = Math.round(100.0*(score/(num_of_q)*100/100.0));
               



                intent.putExtra("Disease" , "뇌졸중");
