package com.example.todak.diabetes;
...
public class doubt_diabetes_Question extends AppCompatActivity {
    double score =0;
    double num_of_q = 13;
    double rate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(doubt_diabetes_Question.this, doubt_diabetes_Result.class);
